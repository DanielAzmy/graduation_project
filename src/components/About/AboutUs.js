...
const AboutUs = () => {
  return (
    ...
    <div className="about-container" >
       <h1>About Us </h1>
       <p> We, Diabetic Retinopathy Clinic, situated at , are a super speciality eye hospital providing a
        ...
        We are committed to achieve and maintain excellence in eye care. Our dedicated team of 
        specialist doctors cater to all eye diseases from corneal pole to retinal pole of the eyeball
        and take care of paediatric to geriatric eye services. A full array of state of the art equipment and a high safety environment
        enables our doctors to diagnose and treat eye problems accurately, safely and effectively. 
        With a focus to provide best eye care treatment, our eye hospital has always been on preventive ophthalmology and hence our activities
        are focused at information, education and informed consent at every step. We stand for a healthy vision of life. 
